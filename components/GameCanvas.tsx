...
import { CAN_IMAGE_URLS, GAME_WORLD_SIZE, CRITTER_ATLAS, CRITTER_FPS_IDLE, CRITTER_FPS_WALK, QUEBEC_BORDER_Y, SPEED_BOOST_DURATION, ROADS, ROAD_TEXTURE_URL, ROAD_TILE_SIZE } from '../constants.ts';
